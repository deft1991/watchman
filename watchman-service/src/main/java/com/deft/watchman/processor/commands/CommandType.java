...
public enum CommandType {
    ...
    GET_DETAILED_MESSAGE("Get detailed message by type, for your chat. Example: /get_detailed_message {TYPE}. If you want to change detailed message call:  /change_detailed_message {TYPE} {bla_bla_bla_new_message}"),
