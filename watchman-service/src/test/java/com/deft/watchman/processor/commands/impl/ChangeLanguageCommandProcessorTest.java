...
class ChangeLanguageCommandProcessorTest extends TestContainerBase {

    @Autowired
    private ChangeLanguageCommandProcessor processor;
    ...
    void testProcessCommand() {
        ...
        chatSettings.setChatLanguage(LanguageType.RUS);
        ...
        assertEquals(LanguageType.valueOf(message.getText().toUpperCase()), optional.get().getChatLanguage());
    }
}
