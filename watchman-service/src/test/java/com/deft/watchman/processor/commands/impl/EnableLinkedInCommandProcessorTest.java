...
import com.deft.watchman.processor.commands.impl.manage.EnableLinkedInCommandProcessor;
...
class EnableLinkedInCommandProcessorTest extends TestContainerBase {

    @Autowired
    private EnableLinkedInCommandProcessor processor;
    ...
    void testProcessCommand() {
        ...
        assertTrue(optional.get().isLinkedinEnable());
    }
}
